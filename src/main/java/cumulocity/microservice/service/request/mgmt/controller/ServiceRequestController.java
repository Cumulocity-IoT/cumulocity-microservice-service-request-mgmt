...
public class ServiceRequestController {
	...
	public ResponseEntity<RequestList<ServiceRequest>> getServiceRequestList(
			...
			@Parameter(in = ParameterIn.QUERY, description = "OrderBy, orders list by `isClosed` and/or `status` and/or `priority` and/or `timestamp`.", schema = @Schema()) @Valid @RequestParam(value = "orderBy", required = false) String[] orderBy,
